$(document).ready(function() {
        ...
        $.ajax({
          type: 'GET',
          url: 'http://localhost:4000/getNextStaffId', // Endpoint to get the next ID
          success: function (data) {
            if (data.success) {
              $('#staff_id').val(data.nextId); // Set the auto-generated ID in the input field
            }
          },
          error: function () {
            alert('Error fetching the next Staff ID.');
          }
        });
